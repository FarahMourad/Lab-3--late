package eg.edu.alexu.csd.datastructure.iceHockey.csx56;
...
public class JUnitTest {
    ...
    public void test() {
        ...
        assertEquals(centerPoints1,h.findPlayers(pic1,8, 9));
        ...
        assertEquals(centerPoints2,h.findPlayers(pic2,3,16));
        ...
        assertEquals(centerPoints3,h.findPlayers(pic3,4,16));
        ...
        assertEquals(centerPoints4,h.findPlayers(pic4,1,3));
        ...
        String [] pic5 ={
                ...
                "22ljj"};
        Point [] centerPoints5 = {};
        assertEquals(centerPoints5,h.findPlayers(pic5,3,1));
        ...
        assertEquals(centerPoints6,h.findPlayers(pic6,1,4));
    }

	private void assertEquals(Point[] centerPoints3, Point[] findPlayers) {
